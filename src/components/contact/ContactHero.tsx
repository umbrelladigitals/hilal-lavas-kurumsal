      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-8 max-w-xl">
           <div className="text-[12px] text-gray-500 font-sans tracking-wide mb-8">
             <Link href="/" className="hover:text-brand-orange cursor-pointer transition-colors">Ana Sayfa</Link> <span className="mx-1">&gt;</span> <span className="text-gray-400 font-medium">İletişim</span>
           </div>
           ...
           <p className="text-gray-700 font-sans text-[15px] leading-relaxed font-medium mb-12">
             Hilal Lavaş olarak, sorularınız, talepleriniz ve iş birlikleriniz için her zaman yanınızdayız. Aşağıdaki kanallardan bize ulaşabilirsiniz.
           </p>
        </div>
      </div>
    </section>
